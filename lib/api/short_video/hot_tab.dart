...
HotTabFeedItem? _mapToHotTabFeedItem(
  ...
  final itemType = (rawType == 'short' || rawType == 'phvideo') &&
          videoUrl.isNotEmpty
  ...
  return HotTabFeedItem(
    ...
    intro: _asString(raw['intro']) ?? _asString(hotLabel?['eventKeyword']) ?? '',
...
HotTabDetailPageResult? _extractHotTabDetailPageResult(dynamic responseData) {
  ...
  final threeLines = banner is Map<String, dynamic> ? banner['threelines'] : null;
